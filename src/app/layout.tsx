...
export const metadata: Metadata = {
    ...
    description:
        "Discover premier properties and real estate opportunities in Dhaka, Bangladesh with Landcraft Holdings. Specializing in luxury apartments and commercial spaces in Uttara, Aftabnagar, Banani, and Mirpur.",
    keywords: [
        "real estate Bangladesh",
        "property in Dhaka",
        "Landcraft Holdings",
        "apartments in Uttara",
        "apartments in Aftabnagar",
        "apartments in Banani",
        "apartments in Mirpur",
        "luxury real estate Dhaka",
    ],
};
